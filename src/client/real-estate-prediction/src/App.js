...
function App() {
  ...
  const handleRentSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://project-service-latest.onrender.com/predict_rent', {
  ...
  const handlePriceSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://project-service-latest.onrender.com/predict_price', {
